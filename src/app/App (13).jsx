  ...
  return (
    <div className="dash-page">
      <section className="panel-card">
        ...
        <h1>Appraisal Workfile Support Package</h1>
        ...
        <div className="btn-row">
          ...
          <button className="btn gold" onClick={printPDF}>Generate Workfile PDF</button>
        </div>
        <div className="status-banner" style={{ marginTop: 12 }}>Workfile PDFs include the subject, imported data summary, market support, GLA support, adjustment grid, and reconciliation support. Keep source MLS exports, inspection notes, and professional judgment support with the final workfile.</div>
      </section>
      <section className="export-trust-grid">
        <article className="export-trust-card"><p className="eyebrow">Report Polish</p><h2>Client-ready structure</h2><p>Exports include subject details, market support, GLA support, adjustment grid, and imported data summaries in a clean print-ready layout.</p></article>
        <article className="export-trust-card"><p className="eyebrow">Audit Trail</p><h2>Methodology visible</h2><p>Key support assumptions, date basis, and professional judgment language are preserved for workfile documentation.</p></article>
        <article className="export-trust-card"><p className="eyebrow">Subscription Value</p><h2>Reusable workflow</h2><p>Save projects, reopen them, revise analysis, and generate updated support without rebuilding the file from scratch.</p></article>
      </section>
      ...
      <section className="panel-card">
        ...
        <div className="btn-row" style={{ marginTop: 16 }}><button className="btn gold" onClick={printPDF}>Generate Workfile PDF</button></div>
      </section>
    </div>
  );
}
